<%@ Page Title="" Language="C#" MasterPageFile="~/View/Store/Manager/Manager.Master" AutoEventWireup="true" CodeBehind="ManagerMain.aspx.cs" Inherits="LogicUniversityStore.View.Store.Manager.WebForm1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="empMainHeader" runat="server">
    <h1>Dashboard<small>Version 2.0</small></h1>
    <a href="SupervisorMain.aspx">ManagerMain.aspx</a>
    <ol class="breadcrumb">

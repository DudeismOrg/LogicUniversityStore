                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <div>
                                        ...
                                        <asp:GridView ID="gvRequestHistory" runat="server" OnRowDataBound = "OnRowDataBound" AutoGenerateColumns="False"   OnSelectedIndexChanged="gvRequestHistory_SelectedIndexChanged" CellPadding="10" CellSpacing="5" ForeColor="#333333" GridLines="None" Height="100px" Width="813px"  >

...
<asp:Content ID="Content2" ContentPlaceHolderID="empMainContentBlock" runat="server">
    ...
    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">                               
                                <div>                                    
                                        <asp:GridView ID="gvRequestHistory" runat="server" AutoGenerateColumns="False"   OnSelectedIndexChanged="gvRequestHistory_SelectedIndexChanged" CellPadding="10" CellSpacing="5" ForeColor="#333333" GridLines="None" Height="93px" Width="977px"  >
